...
//		a. $ystem  		가능 
//		b. channel#112  불가능 특수문자 
//		c. 7eleven 		불가능 첫번쨰 글자 숫자라서
//		d. newmember 	가능 다만, 다른 단어가 붙을 경우 첫 문자를 대문자로 해야함
//		e. $MAX_NUM 	가능 $_ 는 가능
//		f. hello@com 	불가능 특수문자 
//		g. int  		불가능 예약어는 사용할 수 없음 

//		//7. 다음중 변수 초기화가 잘못 된 것은?  c (  char 는 문자 1개만 가능) 
//		a. int b = 255; 
//		b. String s = "T";
//		c. char answer = 'no'; 
//		d. char flag = 'F';
